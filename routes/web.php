...
Route::group(['prefix' => 'admin','middleware' => 'adminauth'], function () {
	...
	Route::get('pending/complain','App\Http\Controllers\AdminController@UnsolvedComplains');
	
	Route::get('view/pending/complains/{id}','App\Http\Controllers\AdminController@ViewUnsolvedComplains');

	Route::get('view/Solved/complains','App\Http\Controllers\AdminController@SolvedComplains');
	
	Route::get('view/single/solved/complain/{id}','App\Http\Controllers\AdminController@ViewSingleSolvedComplains');

	Route::get('view/all/complains','App\Http\Controllers\AdminController@ViewAllComplains');
...
Route::group(['prefix' => 'es','middleware' => 'esauth'], function () {
	...
	Route::post('create/profile','App\Http\Controllers\EsController@CreateProfile')->name('
		changeprofile');

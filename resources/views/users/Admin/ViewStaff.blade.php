				...
				<table class="table table-striped table-bordered">
					...
					<tbody>
						...
						@foreach($data_es as $datas)
							<tr>
								<td>
									<img src="{asset('assets/images/'.$datas->image)}}" style="width:40px;height:40px;border-radius:50%;border:1px solid skyblue;">
								</td>
						...
						@foreach($staffdata as $data)
							<tr>
								<td>
									<img src="{{asset('assets/images/'.$data->image)}}" style="width:40px;height:40px;border-radius:50%;border:1px solid skyblue;">
								</td>

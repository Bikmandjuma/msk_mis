    ...
    <div class="row">
          ...
          <div class="col-sm-8 col-12">
            ...
            @foreach($info as $data)
              <div class="card-header text-center bg-info"><i class="fa fa-user f-w"></i>&nbsp;&nbsp;<b>Admin</b>&nbsp; information <a href="{{route('editinfos',$admin_id)}}"><button class="btn btn-light float-right"><i class="fa fa-edit"></i> Edit</button></a></div>
